            ...
            <div class="full-nav">
                ...
                <nav class="nav2">
                    <ul>
                        ...
                        <li><a href="supervisor_profile.php"><span>03.</span>Profile</a></li>
                        <li><a href="php/supervisor_logout.php"><span>04.</span>Log Out</a></li>
                ...
                <div class="wrapper">
                    <nav id="sidebar">
                        ...
                        <ul class="list-unstyled components">
                            ...
                            <li>
                                <a href="supervisor_projects.php">Projects</a>
                            </li>
                            <hr class="text-center line">
                    ...
                    <h3 style="margin-bottom:30px;text-decoration:underline;">My Projects</h3>
                        <div class="row" style="display:flex;">
                            <div class="col">
                                <div class="border-top border-right myprojects" >
                                <h3 style="margin-bottom:30px;text-decoration:underline;">My Projects</h3>
                                     <?php echo approveProjects() ?>
                                </div>
                            </div>
                        </div>
                    </span>
