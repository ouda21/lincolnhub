        ...
        <div class="container">
                <div class="d-flex justify-content-center h-100">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="needs-validation" novalidate method="POST" action="php/login_sup.php">
                        ...
                        <div class="card-footer">
                            <div class="d-flex justify-content-center links">
                                Don't have an account?<a href="supervisor_register.php">Sign Up</a>
                            </div>
                            <div class="d-flex justify-content-center links">
                                Click here to login as a <a href="login.php">Ambassador</a>
                            </div>
