                ...
                <div class="wrapper">
                    ...
                    <section class="content form-container">
                        <div class="container panel">
                            <div class="border">
                                <h3 class="panel-title" style="text-align:center"><?php echo getInitialDetails("first_name",$amb_id)." ".getInitialDetails("last_name",$amb_id)."'s Report(s)" ?></h3>
                                <div class="row">
                                    <div class="col">
                                        <?php echo getReports($amb_id)?>
                                    </div>
                                </div>
                            </div>
                        </div>
