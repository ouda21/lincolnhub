        ...
        <body>
            ...
            <main>
                <div class="wrapper">
                    ...
                    <h3 style="margin-bottom:30px;text-decoration:underline;">Project Creation</h3>
                        <div class="row">
                            <div class="col">
                                <form class="needs-validation" novalidate  action="php/add_project.php" method="POST">
                                    <div class="form-group">
                                        <label style="text-align:left" for="project name">Project Name</label>
                                        <input type="text" name="project_name" class="form-control form-control-lg" required>
                                        ...
                                        Looks good!
                                         ...
                                         <div class="invalid-feedback">
                                        Please pick ending date.
                                        </div>
                                        <label for="description">Description</label>
                                        <textarea class="form-control form-control-lg" name="description" id="" cols="30" rows="10" required></textarea>
                                        <div class="valid-feedback">
                                        Looks good!
                                         </div>
                                         <div class="invalid-feedback">
                                        ...
                                        <label for="sdg goal">SDG</label>
                                        <select name="sdg" id="" class="form-control form-control-lg" required>
                                            <option value="No poverty">GOAL 1:No Poverty</option>
                                            <option value="Zero Hunger">GOAL 2:Zero Hunger</option>
                                            <option value="Good Health">GOAL 3:Good Health</option>
                                        </select>
