            ...
            <div class="full-nav">
                ...
                <nav class="nav2">
                    <ul>
                        ...
                        <li><a href="supervisor_approve.php"><span>02.</span>Approve Report</a></li>
                ...
                <div class="wrapper">
                    <nav id="sidebar">
                        ...
                        <ul class="list-unstyled components">
                            ...
                            <hr class="text-center line">
                            <li>
                                <a href="supervisor_approve.php">Approve Report</a>
                            </li>
                            <hr class="#">
                            <li>
                                <a href="#">Profile</a>
                    ...
                    <h3 style="margin-bottom:30px;text-decoration:underline;">Profile</h3>
                        <div class="row border-bottom border-left border-right">
                            <div class="col" id="col">
                                <form class="needs-validation" novalidate  action="php/supervisor_function.php" method="POST" enctype="multipart/form-data">
                                <h5 style="margin-bottom:30px;text-decoration:underline;">Update Profile Picture</h5>
                                    ...
                                    <div class="custom-file" style="margin-left:120px;width:60%;height:50px;margin-bottom:15px;">
                                        <input style="margin-left:120px;" type="file" value="<?php echo getInitialDetails("image")?>" name="picture" class="custom-file-input form-control form-control-lg" id="inputGroupFile01">
                                ...
                                <hr>
                                <form class="needs-validation" novalidate  action="php/supervisor_function.php" method="POST">
