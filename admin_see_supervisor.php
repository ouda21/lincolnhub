                                    ...
                                    <div class="col">
                                        <div class="card mb-3" style="max-width: 600px;">
                                            <div class="row no-gutters">
                                                ...
                                                <div class="col-md-8">
                                                <div class="card-body">
                                                    <h5 class="card-title">First Name:&nbsp<?php echo getInitialSupDetails("first_name",$amb_id)?></h5>
                                                    <h5 class="card-title">Last Name:&nbsp<?php echo getInitialSupDetails("last_name",$amb_id)?></h5>
                                                    <h5 class="card-title">Email Address:&nbsp<?php echo getInitialSupDetails("email",$amb_id)?></h5>
